...
public class MainAgent extends Agent {
  ...
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    ...
    synchronized (this) {
      ...
      this.pillars = ((Boolean) _get);
      Object _get_1 = occurrence.parameters[1];
      this.benches = ((Boolean) _get_1);
      Object _get_2 = occurrence.parameters[2];
      this.randomExit = ((Boolean) _get_2);
      Object _get_3 = occurrence.parameters[3];
      this.agentsDelay = ((((Double) _get_3)) == null ? 0 : (((Double) _get_3)).doubleValue());
      Object _get_4 = occurrence.parameters[4];
      Integer agentsSimultaneous = ((Integer) _get_4);
      Object _get_5 = occurrence.parameters[5];
      Integer agentsTotal = ((Integer) _get_5);
      Environment _environment = new Environment(((this.pillars) == null ? false : (this.pillars).booleanValue()), ((this.benches) == null ? false : (this.benches).booleanValue()));
      this.env = _environment;
      Metrics _metrics = new Metrics(agentsSimultaneous, agentsTotal, Double.valueOf(0.0));
      this.met = _metrics;
  ...
  private void $behaviorUnit$MainReady$1(final MainReady occurrence) {
    throw new Error("Unresolved compilation problems:"
      + "\nType mismatch: cannot convert from CustomerUpdateRequest to Event");
  }
  
  private void $behaviorUnit$CustomerInitializedEvent$2(final CustomerInitializedEvent occurrence) {
    UUID id = occurrence.customerID;
    Circle circle = occurrence.circle;
    List<Point2D> objectives = occurrence.objectives;
    synchronized (this) {
      AgentRepresentation _agentRepresentation = new AgentRepresentation(id, circle, objectives);
      this.env.getAgents().add(_agentRepresentation);
    }
  }
  
  private void $behaviorUnit$CustomerUpdatedEvent$3(final CustomerUpdatedEvent occurrence) {
    UUID id = occurrence.customerID;
    Circle circle = occurrence.circle;
    List<Point2D> objectives = occurrence.objectives;
    synchronized (this) {
      boolean _updateAgent = this.env.updateAgent(id, circle, objectives);
      if ((!_updateAgent)) {
        Logging _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER = this.$castSkill(Logging.class, (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING == null || this.$CAPACITY_USE$IO_SARL_CORE_LOGGING.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING = this.$getSkill(Logging.class)) : this.$CAPACITY_USE$IO_SARL_CORE_LOGGING);
        Paint _fill = circle.getFill();
        _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER.info((((("new position of agent " + id) + " (color ") + _fill) + ") invalid."));
      }
    }
  }
  
  private void $behaviorUnit$CustomerExitEvent$4(final CustomerExitEvent occurrence) {
    UUID id = occurrence.customerID;
    Long timeAlive = occurrence.timeAlive;
    synchronized (this) {
      this.env.removeAgent(id);
      this.met.setActiveAgents(Integer.valueOf(this.env.getAgents().size()));
      Long _totalTimeAlive = this.met.getTotalTimeAlive();
      this.met.setTotalTimeAlive(Long.valueOf((((_totalTimeAlive) == null ? 0 : (_totalTimeAlive).longValue()) + ((timeAlive) == null ? 0 : (timeAlive).longValue()))));
      Integer _deadAgents = this.met.getDeadAgents();
      this.met.setDeadAgents(Integer.valueOf((((_deadAgents) == null ? 0 : (_deadAgents).intValue()) + 1)));
      this.met.updateSheetMetrics(timeAlive);
    }
  }
  
  private void $behaviorUnit$ExitApplicationEvent$5(final ExitApplicationEvent occurrence) {
  ...
  private void $behaviorUnit$Destroy$6(final Destroy occurrence) {
    Logging _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER = this.$castSkill(Logging.class, (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING == null || this.$CAPACITY_USE$IO_SARL_CORE_LOGGING.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING = this.$getSkill(Logging.class)) : this.$CAPACITY_USE$IO_SARL_CORE_LOGGING);
    _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER.info("The main agent has stopped.");
  }
  ...
  private void $behaviorUnit$SpaceCreated$14(final SpaceCreated occurrence) {
  }
  
  private void $behaviorUnit$SpaceDestroyed$15(final SpaceDestroyed occurrence) {
  }
  
  private void $behaviorUnit$ParticipantJoined$16(final ParticipantJoined occurrence) {
  }
  
  private void $behaviorUnit$ParticipantLeft$17(final ParticipantLeft occurrence) {
  }
  ...
  private void $guardEvaluator$SpaceDestroyed(final SpaceDestroyed occurrence, final Collection<Runnable> ___SARLlocal_runnableCollection) {
    assert occurrence != null;
    assert ___SARLlocal_runnableCollection != null;
    ___SARLlocal_runnableCollection.add(() -> $behaviorUnit$SpaceDestroyed$15(occurrence));
  }
  
  @SyntheticMember
  @PerceptGuardEvaluator
  private void $guardEvaluator$CustomerUpdatedEvent(final CustomerUpdatedEvent occurrence, final Collection<Runnable> ___SARLlocal_runnableCollection) {
    assert occurrence != null;
    assert ___SARLlocal_runnableCollection != null;
    ___SARLlocal_runnableCollection.add(() -> $behaviorUnit$CustomerUpdatedEvent$3(occurrence));
  }
  ...
  private void $guardEvaluator$SpaceCreated(final SpaceCreated occurrence, final Collection<Runnable> ___SARLlocal_runnableCollection) {
    assert occurrence != null;
    assert ___SARLlocal_runnableCollection != null;
    ___SARLlocal_runnableCollection.add(() -> $behaviorUnit$SpaceCreated$14(occurrence));
  }
  ...
  private void $guardEvaluator$ParticipantJoined(final ParticipantJoined occurrence, final Collection<Runnable> ___SARLlocal_runnableCollection) {
    assert occurrence != null;
    assert ___SARLlocal_runnableCollection != null;
    ___SARLlocal_runnableCollection.add(() -> $behaviorUnit$ParticipantJoined$16(occurrence));
  }
  ...
  private void $guardEvaluator$ExitApplicationEvent(final ExitApplicationEvent occurrence, final Collection<Runnable> ___SARLlocal_runnableCollection) {
    assert occurrence != null;
    assert ___SARLlocal_runnableCollection != null;
    ___SARLlocal_runnableCollection.add(() -> $behaviorUnit$ExitApplicationEvent$5(occurrence));
  }
  
  @SyntheticMember
  @PerceptGuardEvaluator
  private void $guardEvaluator$CustomerInitializedEvent(final CustomerInitializedEvent occurrence, final Collection<Runnable> ___SARLlocal_runnableCollection) {
    assert occurrence != null;
    assert ___SARLlocal_runnableCollection != null;
    ___SARLlocal_runnableCollection.add(() -> $behaviorUnit$CustomerInitializedEvent$2(occurrence));
  }
  ...
  private void $guardEvaluator$ParticipantLeft(final ParticipantLeft occurrence, final Collection<Runnable> ___SARLlocal_runnableCollection) {
    assert occurrence != null;
    assert ___SARLlocal_runnableCollection != null;
    ___SARLlocal_runnableCollection.add(() -> $behaviorUnit$ParticipantLeft$17(occurrence));
  }
  ...
  @SyntheticMember
  @PerceptGuardEvaluator
  private void $guardEvaluator$CustomerExitEvent(final CustomerExitEvent occurrence, final Collection<Runnable> ___SARLlocal_runnableCollection) {
    assert occurrence != null;
    assert ___SARLlocal_runnableCollection != null;
    ___SARLlocal_runnableCollection.add(() -> $behaviorUnit$CustomerExitEvent$4(occurrence));
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (other.pillars != this.pillars)
      return false;
    if (other.benches != this.benches)
      return false;
    if (other.randomExit != this.randomExit)
      return false;
    if (Double.doubleToLongBits(other.agentsDelay) != Double.doubleToLongBits(this.agentsDelay))
      return false;
  ...
  public int hashCode() {
    ...
    final int prime = 31;
    result = prime * result + (this.pillars ? 1231 : 1237);
    result = prime * result + (this.benches ? 1231 : 1237);
    result = prime * result + (this.randomExit ? 1231 : 1237);
    result = prime * result + (int) (Double.doubleToLongBits(this.agentsDelay) ^ (Double.doubleToLongBits(this.agentsDelay) >>> 32));
    return result;
  }
