...
public class CustomerUpdatedEvent extends Event {
  ...
  public CustomerUpdatedEvent(final UUID customerID, final Circle circle, final List<Point2D> objectives) {
  ...
  /**
   * Returns a String representation of the CustomerUpdatedEvent event's attributes only.
   */
  @SyntheticMember
  @Pure
